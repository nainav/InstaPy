...
with smart_run(session):
    hashtags = [
                'asana','yogilife','namaste','yogis','yogalove',
                ...
                'softwaredeveloper','codegoals', 'coder', 'programmer', 'entrepeneur', 'hustle'
    ...
    session.set_comments([
                             u'Great profile!! :heart_eyes: Any feedback for my photos? ',
                             ...
                             u'for my photos?  Please support by following if you like the content.',
                             ...
                             u'recent shot?  Please support by following :smiley:' ,
