...
with smart_run(session):
    hashtags = ['weightloss','weightlossjourney','fitness','healthylifestyle','motivation','healthy','health','workout','diet','fitnessmotivation','healthyfood','fit','weightlosstransformation','gym','fitfam','exercise','nutrition','slimmingworld','healthyeating','fatloss','keto','weightlossmotivation','bodybuilding','transformation','healthyliving','personaltrainer','lifestyle','gymlife','training','bhfyp','weightlifting','gym','weighttraining']
    ...
    session.set_comments([
                             u'Great profile!! :heart_eyes: I am too following my weightloss journey',
                             u'What an amazing shot! :heart_eyes: What do '
                             u'you think of fitness journey :smiley: ?',
                             u'What an amazing shot! :heart_eyes: I think '
                             u'you might also like mine.',
